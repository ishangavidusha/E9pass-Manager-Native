...
class GetFolderUI extends StatefulWidget {
  final Function onPressed;

  const GetFolderUI({Key key, this.onPressed}) : super(key: key);

  @override
  _GetFolderUIState createState() => _GetFolderUIState();
}

class _GetFolderUIState extends State<GetFolderUI> with TickerProviderStateMixin {
